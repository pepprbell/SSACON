...
navbar__WorkerCheckSheet.innerHTML = "<img class='navbar__menu__icon' src='file:///android_asset/www/template/navbar/icons/checksheet_side.png'>"+ "<div class='navbar__menu__title'>체크시트</div>"
navbar__WorkerCheckSheet.className = "navbar__menu"
navbar__WorkerCheckSheet.addEventListener("click", function(){
    window.location = "file:///android_asset/www/template/checklist/checklist.html";
})

const navbar__WorkerMessage = document.createElement("div")
navbar__WorkerMessage.innerHTML = "<img class='navbar__menu__icon' src='file:///android_asset/www/template/navbar/icons/message_side.png'>"+"<div class='navbar__menu__title'>인수인계</div>"
...
navbar__CheckSheet.innerHTML = "<img class='navbar__menu__icon' src='file:///android_asset/www/template/navbar/icons/checksheet_side.png'>"+ "<div class='navbar__menu__title'>체크시트</div>"
...
navbar__CheckSheetList.innerHTML = "<img class='navbar__menu__icon' src='file:///android_asset/www/template/navbar/icons/checksheets_side.png'>"+ "<div class='navbar__menu__title'>체크시트 현황</div>"
navbar__CheckSheetList.className = "navbar__menu"
navbar__CheckSheetList.addEventListener("click", function(){
    window.location = "file:///android_asset/www/template/seeChecklist/seeChecklist.html";
})
...
navbar__BeaconManagement.innerHTML = "<img class='navbar__menu__icon' src='file:///android_asset/www/template/navbar/icons/management_side.png'>"+ "<div class='navbar__menu__title'>비콘 관리</div>"
navbar__BeaconManagement.className = "navbar__menu"
navbar__BeaconManagement.addEventListener("click", function(){
    window.location = "file:///android_asset/www/template/beacon_crud/beacon_crud.html";
})

const navbar__MainMenu = document.createElement("div")
navbar__MainMenu.innerHTML = "<img class='navbar__menu__icon' src='file:///android_asset/www/template/navbar/icons/hamburger_side.png'>"+ "<div class='navbar__menu__title'>목록</div>"
navbar__MainMenu.className = "navbar__menu"
navbar__MainMenu.addEventListener("click", function(){
    window.location = "file:///android_asset/www/template/adminlist/adminlist.html";
})
...
navbar__profile__img.src = "file:///android_asset/www/template/navbar/icons/leessafy.png"
...
navbar__logout.innerHTML = "<img class='navbar__menu__icon' src='file:///android_asset/www/template/navbar/icons/logout_side.png'>"+ "<div class='navbar__menu__title'>로그 아웃</div>"
