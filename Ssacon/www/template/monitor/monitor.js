...
beacons = [
    ...
    {xPos:20,yPos: 50,connetWorkers:[{username:"신민호"},{username:"정현우"}]},
    {xPos:20,yPos: 80,connetWorkers:[{username:"박승범"},{username:"구진범"}]},
    {xPos:50,yPos: 20,connetWorkers:[{username:"신민호"},{username:"정현우"}]},
    {xPos:50,yPos: 50,connetWorkers:[{username:"박승범"},{username:"구진범"}]},
    {xPos:50,yPos: 80,connetWorkers:[{username:"신민호"},{username:"정현우"}]},
    {xPos:80,yPos: 20,connetWorkers:[{username:"박승범"},{username:"구진범"}]},
    {xPos:80,yPos: 50,connetWorkers:[{username:"신민호"},{username:"정현우"}]},
    {xPos:80,yPos: 80,connetWorkers:[{username:"박승범"},{username:"구진범"}]},        
]
